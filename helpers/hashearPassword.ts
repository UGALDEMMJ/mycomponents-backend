...
export function hashPassword(normalPassword: string): Promise<string> {
...
export function verifyPassword(normalPassword: string, hashedPassword: string): Promise<boolean> {
